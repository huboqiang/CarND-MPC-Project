      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          /*
          *  SHIFT CAR TO 90 DEGREES
          *  See https://github.com/huboqiang/CarND-Kidnapped-Vehicle-Project/blob/master/src/particle_filter.cpp
          *  Line 147-150
          *
          */
          ...
          std::cout << "States\t" << v << "\t" << cte << "\t" << epsi << "\t" << psi << std::endl;
